...
---------- | ------- | ------- | -------------------
[jenkins-x/jenkins-x-builders](https://github.com/jenkins-x/jenkins-x-builders.git) | [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller) | [2.0.1221-560](https://github.com/jenkins-x/jenkins-x-builders/releases/tag/v2.0.1221-560) | **0.1.758**: [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller)
[jenkins-x/jx](https://github.com/jenkins-x/jx) | [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller);[github.com/jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow);[github.com/jenkins-x/jenkins-x-builders-ml](https://github.com/jenkins-x/jenkins-x-builders-ml.git);[github.com/jenkins-x/jenkins-x-builders](https://github.com/jenkins-x/jenkins-x-builders.git) | [2.0.1221](https://github.com/jenkins-x/jx/releases/tag/v2.0.1221) | **2.0.1205**: [github.com/jenkins-x/jenkins-x-builders-ml](https://github.com/jenkins-x/jenkins-x-builders-ml.git)<br>**2.0.1212**: [github.com/jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow)<br>**2.0.806**: [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller)
...
[jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller) |  | [0.0.717](https://github.com/jenkins-x-charts/environment-controller/releases/tag/v0.0.717) | 
...
[jenkins-x/jenkins-x-platform](https://github.com/jenkins-x/jenkins-x-platform) |  | [2.0.2033](https://github.com/jenkins-x/jenkins-x-platform/releases/tag/v2.0.2033) | 
...
[jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow) |  | [0.0.1680](https://github.com/jenkins-x-charts/prow/releases/tag/v0.0.1680) | 
...
[grafana/grafana](https://github.com/grafana/grafana) |  | [5.0.3](https://github.com/grafana/grafana/releases/tag/v5.0.3) | 
[prometheus/alertmanager](https://github.com/prometheus/alertmanager) |  | [10.5.3]() | 
...
[jenkins-x/jenkins-x-builders-ml](https://github.com/jenkins-x/jenkins-x-builders-ml.git) |  | [0.1.1137](https://github.com/jenkins-x/jenkins-x-builders-ml/releases/tag/v0.1.1137) | 
...
[cloudbees/arcalos-boot-config](https://github.com/cloudbees/arcalos-boot-config) |  | [1.0.189](https://github.com/cloudbees/arcalos-boot-config/releases/tag/v1.0.189) | 
[cloudbees/jx-tenant-service](https://github.com/cloudbees/jx-tenant-service) | [github.com/cloudbees/arcalos-boot-config](https://github.com/cloudbees/arcalos-boot-config) | [0.0.444](https://github.com/cloudbees/jx-tenant-service/releases/tag/v0.0.444) | **0.0.437**: [github.com/cloudbees/arcalos-boot-config](https://github.com/cloudbees/arcalos-boot-config)
