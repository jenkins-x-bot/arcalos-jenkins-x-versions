...
---------- | ------- | ------- | -------------------
[jenkins-x/jenkins-x-builders](https://github.com/jenkins-x/jenkins-x-builders.git) | [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller) | [2.0.1233-571](https://github.com/jenkins-x/jenkins-x-builders/releases/tag/v2.0.1233-571) | **0.1.758**: [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller)
[jenkins-x/jx](https://github.com/jenkins-x/jx) | [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller);[github.com/jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow);[github.com/jenkins-x/jenkins-x-builders-ml](https://github.com/jenkins-x/jenkins-x-builders-ml.git);[github.com/jenkins-x/jenkins-x-builders](https://github.com/jenkins-x/jenkins-x-builders.git) | [2.0.1233](https://github.com/jenkins-x/jx/releases/tag/v2.0.1233) | **2.0.1230**: [github.com/jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow)<br>**2.0.806**: [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller)
...
[jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller) |  | [0.0.726](https://github.com/jenkins-x-charts/environment-controller/releases/tag/v0.0.726) | 
...
[jenkins-x/jenkins-x-platform](https://github.com/jenkins-x/jenkins-x-platform) |  | [2.0.2052](https://github.com/jenkins-x/jenkins-x-platform/releases/tag/v2.0.2052) | 
...
[jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow) |  | [0.0.1688](https://github.com/jenkins-x-charts/prow/releases/tag/v0.0.1688) | 
...
[jenkins-x/jenkins-x-builders-ml](https://github.com/jenkins-x/jenkins-x-builders-ml.git) |  | [0.1.1147](https://github.com/jenkins-x/jenkins-x-builders-ml/releases/tag/v0.1.1147) | 
...
[cloudbees/arcalos-boot-config](https://github.com/cloudbees/arcalos-boot-config) |  | [1.0.197](https://github.com/cloudbees/arcalos-boot-config/releases/tag/v1.0.197) | 
[cloudbees/jx-tenant-service](https://github.com/cloudbees/jx-tenant-service) | [github.com/cloudbees/arcalos-boot-config](https://github.com/cloudbees/arcalos-boot-config) | [0.0.471](https://github.com/cloudbees/jx-tenant-service/releases/tag/v0.0.471) | **0.0.463**: [github.com/cloudbees/arcalos-boot-config](https://github.com/cloudbees/arcalos-boot-config)
...
[helm/nginx-ingress](https://github.com/helm/charts/tree/master/stable/nginx-ingress):nginx-ingress |  | [1.33.3]() | 
